...
{
    public class AdminFadeKnifePatternsControllerTests
    {
        private readonly Mock<IAdminFadeKnifePatternService> _serviceMock;
        private readonly AdminFadeKnifePatternsController _controller;

        public AdminFadeKnifePatternsControllerTests()
        {
            _serviceMock = new Mock<IAdminFadeKnifePatternService>();
            _controller = new AdminFadeKnifePatternsController(_serviceMock.Object);
        }
        ...
        public async Task Create_Returns_Created_When_Service_Succeeds()
        {
            ...
            created!.ActionName.Should().Be(nameof(AdminFadeKnifePatternsController.Create));
